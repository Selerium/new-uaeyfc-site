    ...
    <div className="w-full h-fit">
      <section className="w-full h-dvh min-h-fit flex flex-col gap-10 justify-center items-center">
        <video
          ...
          loop
        >
          <source src={`${!staging ? basePath : ''}/uaeyfc-hero-video.mp4`}></source>
        </video>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-10 justify-center items-center w-full">
          ...
          <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-center">
            <EmblaCarousel
              images={[
                { alt: "A UAEYFC event photo", url: `${!staging ? basePath : ''}/carousel-1.jpg` },
                { alt: "A UAEYFC event photo", url: `${!staging ? basePath : ''}/carousel-2.jpg` },
                { alt: "A UAEYFC event photo", url: `${!staging ? basePath : ''}/carousel-3.jpg` },
              ]}
            />
          </div>
        </div>
      ...
      <section
        id="contact"
        className={`w-full h-dvh min-h-fit flex flex-col gap-4 justify-center items-center px-8 lg:px-16 py-32 relative bg-[url('${!staging ? basePath : '' }/cross.jpg')] bg-fixed bg-cover bg-center`}
      >
